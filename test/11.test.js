const { 
    ...
    checkCaseOwner,checkCaseDemon,checkCaseNFT,mintCosmosNFT,checkCaseEvmInfo
} = require('./base/helper')
...
async function runAndCheckEvm2Cosmos(){
    ...
    //5.run test case
    await runFromErc721ToCosmosNft("0x432FDd12f13F3D03a8429687db3102e65dBE3060",1,"abc123","");
    ...
    await checkCaseNFT("cdemon2","uptick2",exceptedTitles,exceptedResults);
}
...
async function runAndCheckCosms2Evm(){
    ...
    //cosmos -> evm
    //7.run test case
    await runCaseFromCosmosToErc721("cdemon2","uptick2","0x432FDd12f13F3D03a8429687db3102e65dBE3060",1);
