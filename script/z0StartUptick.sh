...
sed -i -e 's/snapshot-interval = 1500/snapshot-interval = 10/g' $CHAIN_DIR/$CHAINID_1/config/app.toml
sed -i -e 's/snapshot-keep-recent = 0/snapshot-keep-recent = 2/g' $CHAIN_DIR/$CHAINID_1/config/app.toml
