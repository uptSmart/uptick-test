...
async function runAndCheckEvm2Cosmos(){
    ...
    //5.run test case
    await runFromErc721ToCosmosNft("0x432FDd12f13F3D03a8429687db3102e65dBE3060",1,"","uptick2");
    ...
    exceptedResults = [
        "data1","uptick2","name1","uptick103rx84uqa7n4mtmz8f88n4g9m7973rxutrtn7d","uri1","uriHash1"
    ];
    await checkCaseNFT("uptick-432FDd12f13F3D03a8429687db3102e65dBE3060","uptick2",exceptedTitles,exceptedResults);
}
...
async function runAndCheckCosms2Evm(){
    ...
    //cosmos -> evm
    //7.run test case
    await runCaseFromCosmosToErc721("uptick-432FDd12f13F3D03a8429687db3102e65dBE3060","uptick2","0x432FDd12f13F3D03a8429687db3102e65dBE3061","");
    ...
    // exceptedTitles =["data","id","name","owner","uri","uri_hash"]
    // exceptedResults = [
    //     "data1","uptick2","name1","uptick14f06anu6ej0239vgdprl532cm3q4v2ahvz9w8h","uri1","uriHash1"
    // ];
    // await checkCaseNFT("uptick-432FDd12f13F3D03a8429687db3102e65dBE3060","uptick2",exceptedTitles,exceptedResults);
